...
char ssid[] = "RadioWaves-2G";         // your network SSID (name)
char password[] = "MTkL6X?WFX"; // your network password
...
void playArtist()
{
    char sampleArtist[] = "spotify:artist:2h93pZq0e7k5yf4dywlkpM";
...
void playPlaylist()
{
    char samplePlaylist[] = "spotify:playlist:674TD8If4cKezXydMBeeky";
